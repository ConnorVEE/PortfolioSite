            ...
            <Container>
                <div>
                    ...
                    <div className="grid gap-4 py-4 md:grid-cols-3">
                        <div className="rounded-lg border border-secondary p-6 flex flex-col gap-2">
                        ...
                        <div className="rounded-lg border border-secondary p-6 flex flex-col gap-2">
                            ...
                            <p>
                            I enjoy designing scalable, versatile software that stays maintainable as it grows and adapts 
                            to future needs
                            </p>
                        </div>
